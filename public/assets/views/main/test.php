...
<head>
    <meta charset="utf-8">
    <title>Sacred Texts Hub</title>
    <meta name="description" content="Explore the wisdom and teachings of sacred texts from different religious traditions.">
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="main_about text-center">
                    <h1 class="text-black">Sacred Texts Hub</h1>
                    <h2 class="text-white">- & -</h2>
                    <h3 class="text-black text-uppercase">Explore the wisdom and teachings of sacred texts from different religious traditions.</h3>
                ...
                <div class="col-md-5">
                    <div class="features_item">
                        <div class="head_title">
                            <h2 class="text-uppercase">Explore Our Featured Texts</h2>
                        </div>
                        <div class="featured_content">
                            <p>Discover the profound teachings and insights of sacred texts from various religious traditions.</p>
                        ...
                        <div class="features_item2 text-center">
                            ...
                            <div class="col-xs-6">
                                <div class="features_item_text">
                                    <img src="assets1/images/bible.jpg" alt="" class="img-circle" />
                                    <p class="m-top-20">The Bible</p>
                                </div>
                            </div>
                            <div class="col-xs-6">
                                <div class="features_item_text">
                                    <img src="assets1/images/quran.jpg" alt="" class="img-circle" />
                                    <p class="m-top-20">The Quran</p>
                                </div>
                            </div>
                            <!-- Add more sacred texts here -->
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="service_slid">
                        ...
                        <div class="service_slid_item text-center">
                            <div class="service_slid_text">
                                ...
                                <h5 class="text-black m-top-20">Sacred Text Translation</h5>
                            </div>
                            <div class="service_slid_text">
                                <span class="icon icon icon-sports-2 text-black"></span>
                                <h5 class="text-black m-top-20">Interfaith Dialogues</h5>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-5 col-md-offset-1">
                    <div class="service_item sm-m-top-50">
                        ...
                        <div class="service_content">
                            <p>Explore our services aimed at promoting understanding and harmony among different religious communities through the study and appreciation of sacred texts.</p>
                            <a href="#" class="btn btn-default m-top-40">Read More</a>
                        </div>
                    </div>
                </div>
            ...
            <div class="main_teams_content fix">
                <div class="col-md-6">
                    <div class="teams_item">
                        <div class="head_title">
                            <h2 class="text-uppercase">Our <strong>Team & Skill</strong></h2>
                        </div>
                        <p>Meet our dedicated team committed to fostering interfaith understanding and cooperation. Our team members possess diverse skills and expertise to serve our mission.</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="teams_item text-center sm-m-top-50">
                        <div class="row">
                            <div class="col-sm-4">
                                <img src="assets1/images/team1.jpg" alt="" class="img-circle" />
                                <h4 class="m-top-20">John <strong>Doe</strong></h4>
                                <h5>Lead Translator</h5>
                            </div>
                            <div class="col-sm-4">
                                <img src="assets1/images/team2.jpg" alt="" class="img-circle" />
                                <h4 class="m-top-20">Sarah <strong>Smith</strong></h4>
                                <h5>Interfaith Specialist</h5>
                            </div>
                            <div class="col-sm-4">
                                <img src="assets1/images/team3.jpg" alt="" class="img-circle" />
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="teamskillbar clearfix m-top-50 text-uppercase" data-percent="75%">
                                    <label>Interfaith Dialogue</label>
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="teamskillbar clearfix m
                                                ...
                                                <div class="col-md-3">
                                                    <div class="widget_item widget_latest sm-m-top-50">
                                                        ...
                                                        <div class="widget_latst_item m-top-30">
                                                            <div class="item_icon"><img src="assets1/images/ltst-img-1.jpg" alt="" /></div>
                                                        ...
                                                        <div class="widget_latst_item m-top-30">
                                                            <div class="item_icon"><img src="assets1/images/ltst-img-2.jpg" alt="" /></div>
                                                            <div class="widget_latst_item_text">
                                                                <p>Lorem ipsum dolor sit amet, consectetur</p>
                                                                <a href="">21<sup>th</sup> July 2016</a>
                                                            </div>
                                                        ...
                                                        <div class="widget_latst_item m-top-30">
                                                            <div class="item_icon"><img src="assets1/images/ltst-img-3.jpg" alt="" /></div>
                                                            <div class="widget_latst_item_text">
                                                                <p>Lorem ipsum dolor sit amet, consectetur</p>
                                                                <a href="">21<sup>th</sup> July 2016</a>
                                                            </div>
