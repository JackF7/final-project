...
<body>
    ...
    <header class="py-5 bg-image-full" style="background-image: url('https://i.imgur.com/zkRaENS.jpg')">
        <div class="text-center my-5">
            <h1 class="text-gray fs-3 fw-bolder">The Bible</h1>
            <p class="text-gray-50 mb-0">The Primary Sacred Text of Christianity</p>
        </div>
    ...
    <section class="py-5">
        <div class="container text-center mt-5">
            ...
            <a href="https://www.history.com/topics/religion/bible#" class="resource-link" target="_blank">What is the Bible? (History.com)</a>
                <br>
                <a href="https://www.studylight.org/commentary.html" class="resource-link" target="_blank">Verse Commentary (Studylight.org)</a>
                <br>
                <a href="https://bibleresources.org" class="resource-link" target="_blank">Bible Resources (Bibleresources.org)</a>
                <br>
                <a href="https://www.twinkl.com/teaching-wiki/holidays-of-christianity" class="resource-link" target="_blank">Christian Holidays (Twinkl.com)</a>
            </h5>
        </div>
    </section>
